...
class Wish(Base):
    ...
    reservation = relationship(
        "Reservation", back_populates="wish", uselist=False, cascade="all, delete-orphan"
    )
    group_gift = relationship(
        "GroupGift", back_populates="wish", uselist=False, lazy="selectin", passive_deletes=True
    )

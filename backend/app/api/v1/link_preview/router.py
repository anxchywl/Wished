...
from app.modules.link_preview.schemas import LinkPreviewRequest, LinkPreviewResponse, StoreImageRequest, StoreImageResponse
from app.modules.link_preview.service import fetch_link_preview, store_preview_image, validate_preview_url
...
async def post_store_preview_image(
    ...
    if result is None:
        raise HTTPException(status_code=http_status.HTTP_422_UNPROCESSABLE_ENTITY, detail="could not fetch image")
